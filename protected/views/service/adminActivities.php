...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        array('name'=>'seq','sortable'=>!$searchForm->sortTol),
        array('name'=>'day','sortable'=>!$searchForm->sortTol),
		array('name'=>'delivery_date','sortable'=>!$searchForm->sortTol),
		array('name'=>'description','sortable'=>false),
        array('name'=>'supplier','sortable'=>!$searchForm->sortTol),
        array('name'=>'voucher','sortable'=>!$searchForm->sortTol),
		array('name'=>'pickup','sortable'=>!$searchForm->sortTol),
        array('name'=>'pickuptime','sortable'=>!$searchForm->sortTol),
		array('name'=>'dropoff','sortable'=>!$searchForm->sortTol),
        array('name'=>'dropofftime','sortable'=>!$searchForm->sortTol),
        array('name'=>'pax_number','sortable'=>!$searchForm->sortTol),
		array(
			'class'=>'CButtonColumn',
            'template'=>'{view}',
